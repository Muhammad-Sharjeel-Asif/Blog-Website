      ...
      <main className="flex-grow container mx-auto px-6 pt-5 pb-10">
        <section className="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto">
          ...
          <p className="text-lg mb-6">
            If you have any question, or if you would like to collaborate on a project, feel free to reach out!
          </p>
          ...
          <form action="https://api.web3forms.com/submit"
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-700"
                required
              />
            </div>
